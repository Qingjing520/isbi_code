...
from build_project_ontology_resources import (
...
DEFAULT_PROCESSED_DIR = Path(r"F:\Tasks\Ontologies\processed")
DEFAULT_OUTPUT_DIR = DEFAULT_PROCESSED_DIR / "ablations"
