...
from pathology_report_extraction.common.pipeline_defaults import DEFAULT_OUTPUT_ROOT

DEFAULT_OUTPUT_JSON = DEFAULT_OUTPUT_ROOT / "ontology_audits" / "ontology_concept_audit_summary.json"
