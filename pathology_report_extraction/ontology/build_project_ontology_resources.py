...
from pathology_report_extraction.common.pipeline_defaults import DEFAULT_ONTOLOGY_PROCESSED_DIR, DEFAULT_ONTOLOGY_RAW_ROOT, DEFAULT_ONTOLOGY_ROOT


LOGGER = logging.getLogger("build_project_ontology_resources")

DEFAULT_RAW_ROOT = DEFAULT_ONTOLOGY_RAW_ROOT
DEFAULT_OUTPUT_ROOT = DEFAULT_ONTOLOGY_PROCESSED_DIR
